defmodule Flightex.Bookings.ReportTest do
  ...
  describe "build/3" do
    ...
    test "when called, returns the content", %{user_id: user_uuid} do
      ...
      content2 = "#{user_uuid},São Paulo,Bananeiras,#{naive_date_time2}\n"

      Report.build("28/05/2015", "09/05/2015", "report_test.csv")
